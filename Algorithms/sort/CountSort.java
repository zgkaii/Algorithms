...
/**
 * @Author: Mr.Z
 * @DateTime: 2021/01/06 21:16
 * @Description: 计数排序
 **/
public class CountSort implements SortAlgorithms {
    @Override
    ...
    /**
     * Stream Counting Sort The same as method {@link CountSort#sort(List)} } but this method uses
     * stream API
     *
     * @param list The list to be sorted
     */
    ...
    public static void main(String[] args) {
        ...
        print(CountSort.sort(unsortedInts));
        ...
        System.out.println("After Sorting:");
        print(CountSort.sort(unsortedStrings));
