...
/**
 * @Author: Mr.Z
 * @DateTime: 2021/01/05 21:26
 * @Description: 三元搜索
 * <p>
 * A ternary search algorithm is a technique in computer science for finding the minimum or maximum
 * of a unmoral function The algorithm determines either that the minimum or maximum cannot be in
 ...
 **/
public class TernarySearch implements SearchUtil {
    /**
